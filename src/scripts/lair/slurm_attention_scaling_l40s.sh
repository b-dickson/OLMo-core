...
# Set array range when submitting: sbatch --array=1-12 src/scripts/lair/slurm_attention_scaling_l40s.sh
# Optional override: MICROBATCH_DISCOUNT=<float> (default 2.0)
