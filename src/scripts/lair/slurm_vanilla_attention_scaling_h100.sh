...
#SBATCH -J attn-ladder-vanilla-h100
#SBATCH --gres=gpu:H100:2
#SBATCH --mem=256G
#SBATCH --partition general
#SBATCH --output=/data/user/dicksonb/logs/attention-scaling-ladder-vanilla/%A_%a.txt
#SBATCH --error=/data/user/dicksonb/logs/attention-scaling-ladder-vanilla/%A_%a.err
#SBATCH --mail-type=None
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --time=48:00:00
# Set array range when submitting: sbatch --array=1-4 src/scripts/lair/slurm_vanilla_attention_scaling_h100.sh

CONFIG_FILE="${CONFIG_FILE:-src/scripts/lair/vanilla_attention_scaling_config.txt}"
...
mkdir -p "/data/user/dicksonb/logs/attention-scaling-ladder-vanilla"
