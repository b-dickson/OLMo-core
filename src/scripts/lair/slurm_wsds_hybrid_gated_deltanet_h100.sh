...
#SBATCH -J attn-hgdn-h100
#SBATCH --gres=gpu:H100:2
#SBATCH --mem=256G
#SBATCH --partition general
#SBATCH --output=/data/user/dicksonb/logs/attn-ladder-hgdn/%A_%a.txt
#SBATCH --error=/data/user/dicksonb/logs/attn-ladder-hgdn/%A_%a.err
#SBATCH --mail-type=None
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --time=72:00:00
# Submit with: sbatch --array=1-4 src/scripts/lair/slurm_wsds_hybrid_gated_deltanet_h100.sh

CONFIG_FILE="${CONFIG_FILE:-src/scripts/lair/wsds_hybrid_gated_deltanet.txt}"
...
echo "Variant: hybrid_gated_deltanet (no HC); 3:1 GatedDeltaNet:full softmax per 4-layer block"
...
mkdir -p "/data/user/dicksonb/logs/attn-ladder-hgdn"
