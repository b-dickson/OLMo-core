...
#SBATCH -J attn-vanilla-gated-h100
#SBATCH --gres=gpu:H100:2
#SBATCH --mem=256G
#SBATCH --partition general
#SBATCH --output=/data/user/dicksonb/logs/attn-ladder-vanilla-gated/%A_%a.txt
#SBATCH --error=/data/user/dicksonb/logs/attn-ladder-vanilla-gated/%A_%a.err
...
echo "Variant: vanilla_gated (no HC)"
...
mkdir -p "/data/user/dicksonb/logs/attn-ladder-vanilla-gated"
