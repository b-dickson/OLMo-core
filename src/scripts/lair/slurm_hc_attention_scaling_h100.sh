...
#SBATCH -J attn-ladder-hc-h100
#SBATCH --gres=gpu:H100:2
#SBATCH --mem=256G
#SBATCH --partition general
#SBATCH --output=/data/user/dicksonb/logs/attention-scaling-ladder-hc/%A_%a.txt
#SBATCH --error=/data/user/dicksonb/logs/attention-scaling-ladder-hc/%A_%a.err
#SBATCH --mail-type=None
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --time=48:00:00
# Set array range when submitting: sbatch --array=1-4 src/scripts/lair/slurm_hc_attention_scaling_h100.sh

CONFIG_FILE="${CONFIG_FILE:-src/scripts/lair/hc_attention_scaling_config.txt}"
...
LADDER_PROJECT="${LADDER_PROJECT:-attn-scaling-ladder-hc}"
...
mkdir -p "/data/user/dicksonb/logs/attention-scaling-ladder-hc"
